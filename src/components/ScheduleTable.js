            ...
            <table>
              ...
              <tbody>
                  <tr>
                    ...
                    <NavLink to="/https://www.youtube.com/watch?v=dQw4w9WgXcQ">Workshop 1 <!-- replace the link with the workshop 1 drive when it is shared --> </NavLink> 
                  ...
                  <tr>
                    <td><text style={{ color: 'black' }}>2</text></td>
                      ...
                      <NavLink to="/https://www.youtube.com/watch?v=dQw4w9WgXcQ">Workshop 2 <!-- replace the link with the workshop 2 drive when it is shared --> </NavLink> 
                  ...
                  <tr>
                    ...
                    <NavLink to="/https://www.youtube.com/watch?v=dQw4w9WgXcQ">Workshop 3 <!-- replace the link with the workshop 3 drive when it is shared --></NavLink> 
                  ...
                  <tr>
                      ...
                      <NavLink to="/https://www.youtube.com/watch?v=dQw4w9WgXcQ">Workshop 4 <!-- replace the link with the workshop 4 drive when it is shared --></NavLink> 
                  ...
                  <tr>
                      ...
                      <NavLink to="/https://www.youtube.com/watch?v=dQw4w9WgXcQ">Workshop 5 <!-- replace the link with the workshop 5 drive when it is shared --></NavLink> 
